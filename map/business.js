...
function jmap(){
    ...
    function Map(option){
        var defOpts = {
            ...
            getData:null,
            onResult:null
        }, M,opts,context,map,CACHE={},timer;
        ...
        function onResult(data){
            ...
            for(;i<data.length;i++){
                ...
                tmp.html='<div style="background: red;padding: 5px 10px;color: #fff">'+tmp.lpAdd+'</div>';
                var objOverlay = CACHE[opts.key]= new Overlays(tmp);
